package org.seekloud.VideoMeeting.player
...
class Boot extends javafx.application.Application{
  ...
  override def start(primaryStage: Stage): Unit = {
    ...
    val media: Media = new Media("http://10.1.29.245:30389/VideoMeeting/distributor/getRecord/1000008/1569213160185/record.mp4")
