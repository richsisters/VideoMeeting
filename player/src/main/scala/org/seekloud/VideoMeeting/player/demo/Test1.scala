...
class Test1 extends javafx.application.Application{
  ...
  override def start(primaryStage: Stage): Unit = {
    ...
    startBtn1.setOnAction { _ =>
      val file = new File("D:\\test_video\\功s道.mp4")
    ...
    playBox1.getChildren.addAll(canvas1, startBtn1, pauseBtn1, continueBtn1, stopBtn1)
    playBox1.setAlignment(Pos.CENTER)

    val playBox2 = new VBox(5)
    playBox2.getChildren.addAll(canvas2, startBtn2, pauseBtn2, continueBtn2, stopBtn2)
