package org.seekloud.VideoMeeting.player.util

import org.seekloud.VideoMeeting.player.Boot.executor
...
object RecordUtil extends HttpUtil with CirceSupport {
  ...
  def main1(args: Array[String]): Unit = {
    val url = "https://media.seekloud.org:50443/VideoMeeting/distributor/getRecord/1000008/1569213160185/record.mp4"
