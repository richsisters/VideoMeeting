...
var CoreComment = (function () {
    function CoreComment(parent, init) {
        ...
        if(init.hasOwnProperty('gift')){
            this._gift = init['gift'];
        }
        if(init.hasOwnProperty('imgUrl')){
            this._imgUrl = init['imgUrl'];
        }
    ...
    CoreComment.prototype.init = function (recycle) {
        ...
        if(this._gift){
            for(var i=0;i<3;i++){
                ...
                imgNode.className = 'cmt-img img'+i
                imgNode.setAttribute('src',this._imgUrl);
                this.dom.appendChild(imgNode)
            }
            var textNode = document.createElement('div');
            textNode.className = 'cmt-div';
    ...
    Object.defineProperty(CoreComment.prototype, "border", {
        ...
        set: function (b) {
            this._border = b;
            if (this._border) {
                this.dom.style.border = '2px solid #00ffff';
            }
            else {
